...
<head>
  <title>SigaHack - Cadastro de Professor</title>
  ...
  <div id="main">
    ...
    <div id="site_content">
      ...
      <div id="content_container">
        ...
        <div id="content">
          <br/><h1 align="center">Cadastro de Professor</h1>
		<div align="center">
		<?
			if( $_GET['status'] == "ok" ){
			...
			echo("<br/><br/>");
		?>
		<form method="post" action="cadastro.php?tipo_cadastro=5">
		  <table>
		    <tr>
			  <td>Matricula:</td>
			  <td><input type="text" name="matric_prof" size="9" maxlength="7"/></td>
		    <tr/>
		    <tr>
			  <td>Senha:</td>
			  <td><input type="text" name="senha_prof" size="15" maxlength="20"/></td>
		    <tr/>
		    <tr>
			  <td>Nome:</td>
			  <td><input type="text" name="nome_prof" size="40" maxlength="50"/></td>
		    <tr/>
              <tr>
			  <td>CPF:</td>
			  <td><input type="text" name="cpf_prof" size="11" maxlength="11"/></td>
		    <tr/>
			<tr>
			  <td>Departamento:</td>
			  <td>

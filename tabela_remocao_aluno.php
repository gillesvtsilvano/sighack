<?
	...
	$sql = "select matricula_aluno, nome_aluno, curso_aluno from aluno";
	...
	if( $contagem > 0 ){
		...
		echo("<tr>" );
		echo("<td align=\"center\" width=\"10%\"> <b>Matricula </b></td>" );
		echo("<td align=\"center\" width=\"70%\"> <b>Nome </b></td>" );
		echo("<td align=\"center\" width=\"10%\"> <b>Curso</b></td>" );
		echo("<td align=\"center\" width=\"10%\"> <b>Acao </b></td>" );
		echo("</tr>" );
		while ( $linha = mysql_fetch_array( $confirmacao ) ) {
			$sql = "select * from aluno_turma where matricula_aluno='".$linha[0]."'";
			...
			if( mysql_num_rows($resultado) == 0 ){
				echo("<td align=\"center\" > <a href=\"remocao.php?tipo_remocao=6&matric_aluno=" . $linha[0] . "\"> remover </a></td>" );
			}
			else{
		...
		echo("Nao ha alunos cadastrados");
	}

...
<head>
  <title>SigaHack - Realizar Desmatricula</title>
  ...
  <div id="main">
    ...
    <div id="site_content">
      ...
      <div id="content_container">
        ...
        <div id="content">
          <br/><h1 align="center">Turmas matriculadas</h1>
          <br/><br/>
		<p align="center">
		<?
		  if( $_GET['status'] == "ok" ){
			echo("<font color=\"blue\">Desmatricula realizada com sucesso!</font><br/><br/>");
		  }
		  ...
		  include("lista_turmas_desmatricula.php");
		?>

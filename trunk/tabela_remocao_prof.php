<?
	...
	$sql = "select matricula_prof, nome_prof, dept_prof from professor";
	...
	if( $contagem > 0 ){
		...
		echo("<td align=\"center\" width=\"10%\"> <b>Dept</b></td>" );
		echo("<td align=\"center\" width=\"10%\"> <b>Acao </b></td>" );
		echo("</tr>" );
		while ( $linha = mysql_fetch_array( $confirmacao ) ) {
			$sql = "select * from turma where prof_turma='".$linha[0]."'";
			...
			if( mysql_num_rows($resultado) == 0 ){
				echo("<td align=\"center\" > <a href=\"remocao.php?tipo_remocao=5&matric_prof=" . $linha[0] . "\"> remover </a></td>" );
			}
			else{
		...
		echo("Nao ha professores cadastrados");
	}
?>

...
<head>
  <title>SigaHack - Cadastro de Curso</title>
  ...
  <div id="main">
    ...
    <div id="site_content">
      ...
      <div id="content_container">
        ...
        <div id="content">
          <br/><h1 align="center">Cadastro de Curso</h1>
		<div align="center">
		<?
			if( $_GET['status'] == "ok" ){
			...
			echo("<br/><br/>");
		?>
		<form method="post" action="cadastro.php?tipo_cadastro=2">
		  <table>
		    <tr>
			  <td>Codigo:</td>
			  <td><input type="text" name="codigo_curso" size="7" maxlength="5"/></td>
		    <tr/>
		    <tr>
			  <td>Nome:</td>
			  <td><input type="text" name="nome_curso" size="40" maxlength="50"/></td>
		    <tr/>
			<tr>
			  <td>Departamento:</td>
			  <td>
                   <select name="dept_curso">
				 <?

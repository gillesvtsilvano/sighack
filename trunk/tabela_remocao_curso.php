<?
	...
	if( $contagem > 0 ){
		...
		echo("<td align=\"center\" width=\"76%\"> <b>Dept </b></td>" );
		echo("<td align=\"center\" width=\"12%\"> <b>Acao </b></td>" );
		echo("</tr>" );
		while ( $linha = mysql_fetch_array( $confirmacao ) ) {
			$sql = "select * from aluno where curso_aluno='".$linha[0]."'";
			...
			if( mysql_num_rows($resultado) == 0 ){
				echo("<td align=\"center\" > <a href=\"remocao.php?tipo_remocao=2&cod_curso=" . $linha[0] . "\"> remover </a></td>" );
			}
			else{
		...
		echo("Nao ha cursos cadastrados");
	}

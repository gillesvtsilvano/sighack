...
<head>
  <title>SigaHack - Cadastro de Departamento</title>
  ...
  <div id="main">
    ...
    <div id="site_content">
      ...
      <div id="content_container">
        ...
        <div id="content">
          <br/><h1 align="center">Cadastro de Departamento</h1>
		<div align="center">
		<?
			if( $_GET['status'] == "ok" ){
			...
			echo("<br/><br/>");
		?>
		<form method="post" action="cadastro.php?tipo_cadastro=1">
		  <table>
		    <tr>
			  <td>Codigo:</td>
			  <td><input type="text" name="codigo_dept" size="5" maxlength="3"/></td>
		    <tr/>
		    <tr>
			  <td>Nome:</td>
			  <td><input type="text" name="nome_dept" size="40" maxlength="50"/></td>
		    <tr/>
		    <tr>
			  <td></td>
